...
describe('Util tests', () => {
  ...
  describe('createWorkspace', () => {
    it('creates a new workspace', () => {
      const workspace = utils.createWorkspace(testDbString, 'testing')
      expect(workspace).toBeDefined()
  ...
  describe('deleteWorkspace', () => {
    it('deletes a workspace', () => {
      const workspace = utils.createWorkspace(testDbString, 'to be deleted')
      const initialWorkspaces = utils.getWorkspaces(testDbString)
      const success = utils.deleteWorkspace(testDbString, workspace.id)
      expect(success).toBe(true)
      const finalWorkspaces = utils.getWorkspaces(testDbString)
  ...
  describe('addShipment', () => {
    it('adds a new shipment to an existing build', () => {
      ...
      const updatedWorkspace = utils.addShipment(testDbString, workspaceId, newShipment)
  ...
  describe('updateShipment', () => {
    it('updates an existing shipment', () => {
      ...
      const updatedWorkspace = utils.updateShipment(testDbString, workspaceId, shipmentToUpdate)
  ...
  describe('deleteShipment', () => {
    it('deletes an existing shipment', () => {
      ...
      const success = utils.deleteShipment(testDbString, workspaceId, shipmentIdToDelete)
      expect(success).toBe(true)
      const updatedWorkspace = utils.getWorkspace(testDbString, workspaceId)
  ...
  describe('updateBuildNumber', () => {
    it('updates the build number of a build shipment', () => {
      ...
      const updatedWorkspace = utils.updateBuildNumber(
        testDbString,
        workspaceId,
        buildShipmentId,
        newBuildNumber
  ...
  describe('deleteBuildShipment', () => {
    it('deletes an existing build shipment', () => {
      ...
      const success = utils.deleteBuildShipment(testDbString, workspaceId, buildShipmentIdToDelete)
      expect(success).toBe(true)
      const updatedWorkspace = utils.getWorkspace(testDbString, workspaceId)
